    ...
    class Baza {
        ...
        function spojiDB(){
            ...
            if($this->veza->connect_errno){
                echo "Neuspješno spajanje na bazu ". $this->veza->connect_errno . ", ".$this->veza->connect->error;
                $this->greska = $this->veza->connect_error;
            }
            $this->veza->set_charset('utf8');
            if($this->veza->connect_errno){
                echo "Neuspješno postavljanje znakova za bazu ".$this->veza->connect_errno.",".$this->veza->connect->error;
                $this->greska = $this->veza->connect_error;
            }
            return $this->veza;
        }
